...
3. Implement the requested behavior, update relevant documentation, and add or update focused tests when the change warrants them. Do not expand scope into unrelated cleanup.
